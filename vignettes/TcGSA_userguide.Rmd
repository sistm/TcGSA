...
### Download `gmt`s from *Hejblum et al., 2015*
...
design_list <-lapply(GEOquery::GSMList(gse.soft), function(x){GEOquery::Meta(x)$characteristics_ch1})
