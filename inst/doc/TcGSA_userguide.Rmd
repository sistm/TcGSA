...
within a gene set. For more details, check the [published article in PLOS Computational Biology](http://dx.plos.org/10.1371/journal.pcbi.1004310).
...
study gene expression over time. For more details, check the article from *Obermoser et al.* [here](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3492754/).
