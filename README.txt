...
In its current version, TcGSA depends on 'multtest' package which is not available on CRAN,
...
Hejblum, B.P., Skinner, J., Thiebaut, R., 2013, TcGSA: a gene set approach for longitudinal gene expression data analysis, submitted.
